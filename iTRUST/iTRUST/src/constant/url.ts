// const domain = 'https://daiichi.mobile';
export enum urlApp {
  // APIURL = 'https://apis.fplatform.fincorp.vn/web/v1/', //that
  // APIURL = 'https://apis.mio-uat.vinacapital.com/web/v1/',
  ...
  DomainName = 'https://fplatform.mobile', // moi doi tac sua origin fplatform
}
